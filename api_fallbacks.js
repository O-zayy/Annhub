...
async function fetchTopAnimeFromHardcoded(page, append) {
    const hardcodedAnime = [
        ...
        { mal_id: 38000, title: "Demon Slayer", score: "8.52", status: "FINISHED", synopsis: "A family is attacked by demons and only two members survive.", images: { webp: { large_image_url: "https://cdn.myanimelist.net/images/anime/1286/99889.jpg" } }, genres: [{ name: "Action" }], trailer: { embed_url: null } },
        { mal_id: 5026, title: "Doraemon", score: "8.30", status: "RELEASING", synopsis: "The robotic cat Doraemon is sent back in time to aid Nobita Nobi.", images: { webp: { large_image_url: "https://cdn.myanimelist.net/images/anime/13/75276.jpg" } }, genres: [{ name: "Comedy" }], trailer: { embed_url: null } },
        { mal_id: 9000, title: "Shinchan", score: "7.80", status: "RELEASING", synopsis: "The daily adventures of a rambunctious 5-year-old boy named Shinnosuke Nohara.", images: { webp: { large_image_url: "https://cdn.myanimelist.net/images/anime/2/86588.jpg" } }, genres: [{ name: "Comedy" }], trailer: { embed_url: null } }
    ];
